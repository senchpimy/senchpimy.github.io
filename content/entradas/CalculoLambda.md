...
**Reglas de inferencia**: Una regla de Inferencia es una forma logica que consiste en una función que toma una premisa, analiza su 
...
**reduccion beta**: Consiste en reemplazar la variable con su expresion en el cuerpo de la abstraccion, es decir dado una abstraccion lambda y un argumento reemplazarlo por su valor mapeado, si la función le suma uno a cualquier argumento entonces su reduccion beta sería el numero
