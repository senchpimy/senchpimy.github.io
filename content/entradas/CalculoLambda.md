...
**reduccion beta**: Consiste en reemplazar la variable con su expresion en el cuerpo de la abstraccion, es decir dado una abstraccion lambda y un argumento reemplazarlo por su valor mapeado, si la función le suma uno a cualquier argumento entonces su reduccion beta seria el numero
