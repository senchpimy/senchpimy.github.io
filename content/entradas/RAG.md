...
semánticamente para después pasarlos al LLM para un postprocesado.
...
Uno de los puntos encontra de esta tecnica es que ahora existen muchos más posibles puntos de fallo en esta arquitectura.
...
También se puede aplicar tecnicas como dados *K* vectores relevantes eliminar resultados que no estén relacionados, esta técnica se llama **autocut**,
...
fuerza al modelo a generar una respuesta en la que dice que no posee información relevante en lugar de alucinar algún resultado.
