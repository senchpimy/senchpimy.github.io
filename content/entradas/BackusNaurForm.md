...
**Gramática libre de contexto**: En lenguajes formales una gramática libre de contexto es una gramática cuyas reglas de produccion pueden ser aplicadas a simbolos no no-terminales sin importar su contexto.
