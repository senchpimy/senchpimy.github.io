...
El algoritmo de Auto Regresión en la generación de imágenes consiste en dada una secuencia de píxeles intentar predecir el siguiente o los siguientes N píxeles.
...
-   Si se intentan generar muchos píxeles por cada ejecución el modelo generará un promedio de todas las posibilidades que esos píxeles puedan ser, por lo que existe un límite en que tan grande cada generación puede ser. Para solucionar esto se aplica Auto Regresión Generalizada,
