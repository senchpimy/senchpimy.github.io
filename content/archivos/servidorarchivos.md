...
---
 ...
 Solo hay que configurar un archivo .json, el cual contiene los archivos los cuales pueden ser requeridos, pero considero que lo debería cambiar, ya que para conseguir un archivo es necesario saber la ubicación de el archivo en la maquina que lo hostea, lo cual puede causar problemas.
