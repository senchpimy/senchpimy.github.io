...
Ollama puede usar es solo un administrador, como backend utiliza **llama.cpp**, llama.cpp es un backend completo, flexible y portatil del cual leia los modelos con el formato **GGML**, pero conforme los modelos crecian y 
