...
```
 ...
 Evaluamos estos dos elementos (el primero y el último) en minuscula pues la el estring puede contener minusculas y mayusculas, si son diferentes entonces estos no se pueden leer de atras hacía delante de la misma manera y por lo tanto no sol palindromos y regresamos false.
