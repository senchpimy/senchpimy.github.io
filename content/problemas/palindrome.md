...
```
 ...
 En la primera linea primero eliminamos todos los caracteres que no sean alfanumericos, la funcion **.erase** toma una funcion la cual filtra desde el principio hasta el final todos los elementos que no sean alfanumericos.
 ...
 Evaluamos estos dos elementos (el primero y el ultimo) en minuscula pues la el estring puede contener minusculas y mayusculas, si son diferentes entonces estos no se pueden leer de atras hacía delante de la misma manera y por lo tanto no sol palindromos y regresamos false.
