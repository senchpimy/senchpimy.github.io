...
```
 ...
 decimos que seleccionamos todos los caracteres en una linea, con el texto **[0-9]** decimos que el caracter en esa posición puede ser un valor desdel 0 hasta el 9
